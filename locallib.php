...
function block_ned_sidebar_migrate_old_section($course, $sectionnum) {
    ...
    $sectioninfo = $DB->get_record('course_sections', array('course' => $course->id, 'section' => $sectionend),
        'id, section, name, visible'
    );
...
function block_ned_sidebar_move_section($course, $sectionnum) {
    ...
    $sectioninfo = $DB->get_record('course_sections', array('course' => $course->id, 'section' => $newsection),
        'id, section, name, visible'
    );
    if (false === $sectioninfo) {
        debugging('could not find section '.$sectionend, DEBUG_DEVELOPER);
