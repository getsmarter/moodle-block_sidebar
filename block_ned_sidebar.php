...
class block_ned_sidebar extends block_list {
    ...
    public function get_content() {
        ...
        if (!$cs = $DB->get_record('course_sections', array('section' => $section->section, 'course' => $course->id))) {
            debugging('Could not get course section record for section '.$section->section, DEBUG_DEVELOPER);
            return $this->content;
        }
