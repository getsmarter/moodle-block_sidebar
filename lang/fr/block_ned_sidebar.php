...
$string['configsectionnumber'] = 'Entrez le numéro de départ de la nouvelle section';
$string['configtitle'] = 'Entrez le nouveau nom du bloc';
$string['error_couldnotaddsection'] = 'Ajout de nouvelle section au cours impossible';
