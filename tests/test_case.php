...
class blockSideBarTestcase extends advanced_testcase {
    ...
    /**
     * Test that the Side Bar block activity section is appropriately added to a
     * course when that course contains orphaned sections but
     * no activity modules within an orphaned section (orphaned being sections
     * that exist beyond the number of sections configured for
     * the course).
     */
    ...
    /**
     * Test that the Side Bar block activity section is appropriately
     * added to a course when that course contains one orphaned section
     * and that section contains an activity module (orphaned being
     * sections that exist beyond the number of sections configured for
     * the course).
     */
    ...
    /**
     * Test that the old sidebar course section migrates into the new position
     * when there are no "fillter" sections that have been created.
     */
